...
# Example usage
directory_to_scan = 'redmi_phase2'
patterns_to_search = [
    ...
    # Patterns for HTTP client libraries but only if they are followed by a method that sends data
    ...
    # More precise matching for variable names that could contain sensitive information
    r"\burl\b|\buri\b|\bendpoint\b|\bapi\b|\bpath\b",
    
    
    # Matching onResponse and onFailure with the assumption they're tied to network activity
    ...
    # Avoid generic headers, look for those that are typically associated with user identification or device information
    ...
    # More specific Retrofit pattern
